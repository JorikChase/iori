...
export const CATALOG = [
  ...
  ['Eden cluster', 3, [0, 0.02, 0.02, 3], [0, 0, 0, 0], R.eden, 'lichens and minerals', 0.3, { nutrient: 1.0, agar: 0.5 }],
  ['Diffusion-limited dendrite', 3, [1, 0.02, 0.6, 0], [0, 0, 0, 0], R.frost, 'lichens and minerals', 0.3, { nutrient: 0.6, agar: 0.5 }],
  ['Dense branching aggregate', 3, [0.5, 0.03, 0.5, 0.4], [0, 0, 0, 0], R.eden, 'lichens and minerals', 0.3, { nutrient: 0.7, agar: 0.5 }],
  ['Needle frost', 3, [2.2, 0.06, 0.6, 0], [0, 0, 0, 0], R.frost, 'lichens and minerals', 0.3, { nutrient: 0.7, agar: 0.5 }],
  ['Rhizocarpon geographicum — map lichen', 3, [0.7, 0.05, 0.12, 1.0], [0, 0, 0, 0], R.rhizo, 'lichens and minerals', 0.4, { nutrient: 0.8, agar: 0.5 }],
  ['Xanthoria parietina', 3, [0.4, 0.08, 0.1, 1.4], [0, 0, 0, 0], R.xanth, 'lichens and minerals', 0.5, { nutrient: 0.8, agar: 0.5 }],
  ['Manganese dendrite', 3, [1.5, 0.03, 0.6, 0], [0, 0, 0, 0], R.mangan, 'lichens and minerals', 0.2, { nutrient: 0.5, agar: 0.5 }],
...
].map(([name, kernel, P, Q, ramp, category, radius, dish]) => ({
  id: name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, ''), name, kernel, P, Q, ramp, category, radius, dish,
}));
